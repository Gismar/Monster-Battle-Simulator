    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                ConsoleExtras.GetBoolInput(Console.ReadLine(), out play);
        ...
        public static Race GetPlayerInputRace()
        {
            ...
            do
            {
                ...
                worked = ConsoleExtras.GetEnumInput(Console.ReadLine(), out object output);
                option = worked ? (Race)output : Race.Goblin;
